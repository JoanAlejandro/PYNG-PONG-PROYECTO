...
cred = credentials.Certificate("database-pyng-p0ng-firebase-adminsdk-fbsvc-3c3f4041c9.json")
...
def iniciar_juego():
    ...
    while True:
        ...
        if bola.left <= 0 or bola.right >= ANCHO:
            pygame.quit()
            messagebox.showinfo("Juego Terminado", "Fin del juego Presiona ACEPTAR para volver al menú principal.")
            return
